                ...
                <main>
                            ...
                            >
                                <Card>
                                    <CardHeader
                                        ...
                                        title={`${
                                            pet.name
                                            }, the ${pet.species.toLowerCase()}`}
                                    />
                                    <CardActions className={classes.actions}>
                                        <Button component={Link} to={`/pet/${pet.id}`} size="small">View</Button>
                                    </CardActions>
                                </Card>
                            </Grid>
                        ))}
                    ...
                    <Dialog onClose={onToggleModal} open={isDeleteModalOpen}>
                        ...
                        <DialogActions>
                            ...
                            <Button data-testid="confirm-delete-button" onClick={onConfirmDelete}>Delete</Button>
                        </DialogActions>
                    </Dialog>
                    <Snackbar
                        action={
